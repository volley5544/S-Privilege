...
import 'schema/customer_contacts_record.dart';
...
export 'schema/customer_contacts_record.dart';
export 'schema/image_link_storage_record.dart';
export 'schema/build_version_record.dart';

/// Functions to query CustomerContactsRecords (as a Stream and as a Future).
Future<int> queryCustomerContactsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CustomerContactsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CustomerContactsRecord>> queryCustomerContactsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      CustomerContactsRecord.collection,
      CustomerContactsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CustomerContactsRecord>> queryCustomerContactsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
